...
{
    public class AccomdationMappingRepository : BaseRepository<AccomdationMapping>, IAccomdationMappingRepository
    {
        public AccomdationMappingRepository(ApplicationDbContext context) : base(context)
        {
        }
    }
}
